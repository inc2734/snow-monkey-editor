...
addFilter(
	'editor.BlockEdit',
	'snow-monkey-editor/ordered-list-circle/block-edit',
	createHigherOrderComponent(
		( BlockEdit ) => {
			return ( props ) => {
				const {
				...
				if ( ! block.classList.contains( 'is-style-sme-ordered-list-circle' ) ) {
		...
		'withSnowMonkeyEditorOrderdListCircleBlockEdit'
	)
);
